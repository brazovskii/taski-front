...
Создать валидатор, запросить у пользователя логин и пароль. 

Далее попросить пользователя залогиниться поочередно запросив, ввести данные. 

Если верно введен логин и пароль, вывести сообщение **Добро пожалоВать**. Далее записать эти данные в обьект и поместить их в нужные ключи, и если пользователь ввел все верно вывести ключи в консоль.
